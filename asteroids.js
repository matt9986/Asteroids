...
window.Asteroids.MovingObject = function(x_coord, y_coord) {
  this.x_coord = x_coord;
  this.y_coord = y_coord;
}

MovingObject = window.Asteroids.MovingObject
...
window.Asteroids.Asteroid = function(x_coord, y_coord) {
  this.x_coord = x_coord;
  this.y_coord = y_coord;
...
window.Asteroids.randomAsteroid = function(max_x, max_y, max_speed) {
...
window.Asteroids.Game = function() {
  ...
  this.asteroids = [];
  this.asteroids.push(window.Asteroids.randomAsteroid(max_x, max_y, 10));
...
window.Asteroids.Ship = function(ctx){
  this.angle = 0;
  this.x_coord = (800/ 2);
  this.y_coord = (600 / 2);
  this.x_vel = 0;
...
window.Asteroids.Bullet = function(x_coord, y_coord, x_vel, y_vel){
  this.x_coord = x_coord;
  this.y_coord = y_coord;
